...
import { getContactInformation, getSelectedDate, getSelectedTime } from 'src/store/reservationProcess/selectors'
...
const ReservationSummary = () => {
    ...
    return (
        <Grid container direction="column">
            <Typography>{`Termín: ${appointmentDate} ${appointmentTime}`}</Typography>
